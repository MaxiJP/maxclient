...
public class GameSettings
{
    ...
    public KeyBinding TOGGLE_SPRINT = new KeyBinding("Toggle Sprint", Keyboard.KEY_LCONTROL, "MaxClient");
    ...
    private void addClientKeybinds() {
    	this.keyBindings = ((KeyBinding[])ArrayUtils.add(this.keyBindings, this.TOGGLE_SPRINT));
	}
